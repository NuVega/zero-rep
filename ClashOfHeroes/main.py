...
COMPUTER_NAMES = [
    "Александр Македонский", "Джон Уик", "Кратос", "Геракл", "Конан-варвар",
    "Геральт из Ривии", "Мастер Чиф", "Эцио Аудиторе", "Данте", "Лара Крофт",
    "Безумный Макс", "Робин Гуд", "Тор", "Локи", "Артас", "Саурон",
    "Чёрная Вдова", "Железный Человек", "Солид Снейк", "Кассиопея",
    "Танос", "Капитан Америка", "Бэтмен", "Супермен", "Джек Воробей",
    "Леон", "Арагорн", "Леголас", "Гимли", "Гаррош Адский Крик",
    "Джон Сноу", "Кхал Дрого", "Дракс Разрушитель", "Спартак", "Цезарь",
    "Наполеон", "Хитман", "Кейси Джонс", "Минотавр", "Синбад",
    "Люк Скайуокер", "Мастер Йода", "Дарт Вейдер", "Энакин Скайуокер",
    "Оби-Ван Кеноби", "Кенши", "Саб-Зиро", "Скорпион", "Рейден", "Китана"
]
